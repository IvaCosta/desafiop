...
describe SubscribersController do
  ...
  describe "index" do
    before do
      Subscribe.create!(name: 'Baked Potato w/ Cheese')
      Subscribe.create!(name: 'Garlic Mashed Potatoes')
      Subscribe.create!(name: 'Potatoes Au Gratin')
      Subscribe.create!(name: 'Baked Brussel Sprouts')
